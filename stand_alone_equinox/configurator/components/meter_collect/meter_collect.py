...
# for result scaling
m_power_scale      = int(os.getenv("M_POWER_SCALE"))
m_volt_scale       = int(os.getenv("M_VOLT_SCALE"))
m_current_scale    = int(os.getenv("M_CURRENT_SCALE"))
m_energy_sum_scale = int(os.getenv("M_ENERGY_SUM_SCALE"))
m_frequency_scale  = int(os.getenv("M_FREQUENCY_SCALE"))
